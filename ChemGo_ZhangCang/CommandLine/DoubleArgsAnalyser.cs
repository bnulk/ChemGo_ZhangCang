...
namespace ChemGo_ZhangCang.CommandLine
{
    internal class DoubleArgsAnalyser
    {
        ...
        private void ObtainInputFileFullName()
        {
            ...
            {
                throw new CommandLine_Exception("ChemGo.CommandLine.Analyser.DoubleArgsAnalyser.ObtainInputFileFullPath() Error, Input file does not exist.");
            }
        }
        ...
        private void ObtainOutputFileFullName()
        {
            if (IsValidFilePath(arg1))
            {
                ...
                {
                    throw new CommandLine_Exception("ChemGo.CommandLine.Analyser.DoubleArgsAnalyser.ObtainOutputFileFullName() Error, The extension of the output file must be \" kun \"");
                }
            }
            else
            {
                throw new CommandLine_Exception("ChemGo.CommandLine.Analyser.DoubleArgsAnalyser.ObtainOutputFileFullName() Error, Invalid Output File Path.");
            }
